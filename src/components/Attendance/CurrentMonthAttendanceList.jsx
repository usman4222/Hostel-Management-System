        ...
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          <div className="flex md:justify-between md:flex-row flex-col">
            <h4 className="mb-6 text-xl font-semibold text-black dark:text-white">
              {getCurrentMonthName()} Attendance List{" "}
              <span className="bg-black px-2 mr-2">Name:</span>
              <span className="text-[#E1D9D1]">{userName},{" "}</span>
              <span className="bg-black px-2 mr-2">Reg No:</span>
              <span className="text-[#E1D9D1]">{regNo},{" "}</span>
              <span className="bg-black px-2 mr-2">Class:</span>
                ...
                <tbody>
                  {attendanceArray.length > 0 ? (
                    ...
                    <tr>
                      <td
                        colSpan="5"
                        className="py-5 px-4 text-center text-black dark:text-white"
                      >
